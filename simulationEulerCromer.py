...
class SimulationEulerCromer(Simulation):
    """Used in Experiment 2 for comparison. Uses the Euler Cromer instead of Beeman method for position calculations.
    ...
    def _update_velocities(self):
        """Updates the velocity of all bodies using Euler Cromer method.
        """
    ...
    def _update_positions(self):
        """Updates the position of all bodies using Euler Cromer method.
        """
        for body in self.body_list:
    ...
    def run_simulation(self):
        """Uses Euler Cromer method to update positions of all bodies for length of simulation and writes total energy to file.
        """
